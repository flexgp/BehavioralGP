...
/**
 * Created by stevenfine on 7/25/16.
 */
public class OrdinaryGP extends FitnessFunction {
    private final DataJava data;
    private int pow;
    private final boolean USE_INT;
    public static String FITNESS_KEY = Parameters.Operators.ORDINARY_GP_FITNESS;
     ...
     * @param data
     */
    public OrdinaryGP(DataJava data) {
        this(data, 2, false,1);
    }

    public OrdinaryGP(DataJava aData, int aPow, boolean is_int,int anumThreads) {
        this.data = aData;
        pow = aPow;
        USE_INT = is_int;
